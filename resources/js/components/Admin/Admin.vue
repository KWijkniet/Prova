    ...
    <div class="container">
        <div class="jumbotron jumbotron-fluid">
            <div class="col-md-10 offset-md-1">
                <h1>
                    Welcome, {{ currentUser.username }}! [{{currentUser.education != null ? currentUser.education.name : currentUser.domain != null ? currentUser.domain.name : 'CEO'}}]
                </h1>
        ...
        <div class="d-flex flex-row flex-wrap d-inline justify-content-between">

            <div class="d-flex flex-row align-items-center item pointer" v-if="hasAccess('/adminexams')" v-on:click="redirect('/adminexams')">
            ...
            <div class="d-flex flex-row align-items-center item pointer"  v-if="hasAccess('/adminstudents')" v-on:click="redirect('/adminstudents')">
            ...
            <div class="d-flex flex-row align-items-center item pointer"  v-if="hasAccess('/manageeducations')" v-on:click="redirect('/manageeducations')">
                <i class="icon fas fa-user-graduate"></i>
                <div class="d-flex align-items-stretch">
                    Manage Educations
                </div>
            ...
            <div class="d-flex flex-row align-items-center item pointer" v-if="hasAccess('/planstudents')" v-on:click="redirect('/planstudents')">
            ...
            <div class="d-flex flex-row align-items-center item pointer"  v-if="hasAccess('/inviteusers')" v-on:click="redirect('/inviteusers')">
            ...
            <div class="d-flex flex-row align-items-center item pointer"  v-if="hasAccess('/manageadmins')" v-on:click="redirect('/manageadmins')">
            ...
            <div class="d-flex flex-row align-items-center item pointer"  v-if="hasAccess('/managedomains')" v-on:click="redirect('/managedomains')">
            ...
            <div class="d-flex flex-row align-items-center item pointer"  v-if="hasAccess('/log')" v-on:click="redirect('/log')">
...
.item:hover{
    ...
    -moz-box-shadow: 5px 5px 32px -18px rgba(0,0,0,0.75);
